...
[here](https://github.com/Picovoice/wake-word-benchmark). Below is miss rate measurements for different engines given a fixed
...
![Accuracy](https://github.com/Picovoice/wake-word-benchmark/blob/master/doc/img/summary.png )
